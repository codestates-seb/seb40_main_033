	...
	const tossPay = () =>
		loadTossPayments(clientKey ?? '').then((tossPayments) => {
			tossPayments.requestPayment('카드', {
				...
				successUrl:
					'http://ec2-43-202-198-203.ap-northeast-2.compute.amazonaws.com:8080/payments/general/success',
				failUrl:
					'http://ec2-43-202-198-203.ap-northeast-2.compute.amazonaws.com:8080/payments/fail',
				validHours: 24,
				cashReceipt: {
					type: '소득공제',
				},
